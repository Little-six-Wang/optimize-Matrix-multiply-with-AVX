# Optimization_8x8_14
Copy the contents of file `MMult_8x8_13.c` into a file named `MMult_8x8_14.c` and change the contents:
...
```
Modified on the basis of MMult_4x4_13.c, this modification mainly packaging B like packaging A, while packaging A, to indirect addressing.

This time the performance graph will look something like:

![compare MMult_8x8_13 with MMult_8x8_14](picturer/compare_MMult_8x8_13_MMult_8x8_14.png)

You can see a slight drop in performance, and I think the reasons are as follows:

In this version, the B block is repeatedly packaged, which adversely affects performance.
