# Optimization_8x8_9
Copy the contents of file `MMult_8x8_8.c` into a file named `MMult_8x8_9.c` and change the contents:
...
![compare MMult_8x8_8 with MMult_8x8_9](picturer/compare_MMult_8x8_8_MMult_8x8_9.png)

As you can see, there is little change in performance, since this change only adjusts the order of the inner product, but it prepares for subsequent optimizations.
