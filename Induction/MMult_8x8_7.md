# Optimization_8x8_7
Copy the contents of file `MMult_8x8_6.c` into a file named `MMult_8x8_7.c` and change the contents:
...
void AddDot8x8(int k, double* a, int lda, double* b, int ldb, double* c, int ldc){
	...
	for(p = 0; p < k; p++){
		...
		c_04_reg += a_0p_reg * *b_p4_pntr;
		c_05_reg += a_0p_reg * *b_p5_pntr;
		c_06_reg += a_0p_reg * *b_p6_pntr;
		c_07_reg += a_0p_reg * *b_p7_pntr;

		c_10_reg += a_1p_reg * *b_p0_pntr;
		c_11_reg += a_1p_reg * *b_p1_pntr;
		c_12_reg += a_1p_reg * *b_p2_pntr;
		c_13_reg += a_1p_reg * *b_p3_pntr;
		c_14_reg += a_1p_reg * *b_p4_pntr;
		c_15_reg += a_1p_reg * *b_p5_pntr;
		c_16_reg += a_1p_reg * *b_p6_pntr;
		c_17_reg += a_1p_reg * *b_p7_pntr;

		c_20_reg += a_2p_reg * *b_p0_pntr;
		c_21_reg += a_2p_reg * *b_p1_pntr;
		c_22_reg += a_2p_reg * *b_p2_pntr;
		c_23_reg += a_2p_reg * *b_p3_pntr;
		c_24_reg += a_2p_reg * *b_p4_pntr;
		c_25_reg += a_2p_reg * *b_p5_pntr;
		c_26_reg += a_2p_reg * *b_p6_pntr;
		c_27_reg += a_2p_reg * *b_p7_pntr;

		c_30_reg += a_3p_reg * *b_p0_pntr;
		c_31_reg += a_3p_reg * *b_p1_pntr;
		c_32_reg += a_3p_reg * *b_p2_pntr;
		c_33_reg += a_3p_reg * *b_p3_pntr;
		c_34_reg += a_3p_reg * *b_p4_pntr;
		c_35_reg += a_3p_reg * *b_p5_pntr;
		c_36_reg += a_3p_reg * *b_p6_pntr;
		c_37_reg += a_3p_reg * *b_p7_pntr;

		c_40_reg += a_4p_reg * *b_p0_pntr;
		c_41_reg += a_4p_reg * *b_p1_pntr;
		c_42_reg += a_4p_reg * *b_p2_pntr;
		c_43_reg += a_4p_reg * *b_p3_pntr;
		c_44_reg += a_4p_reg * *b_p4_pntr;
		c_45_reg += a_4p_reg * *b_p5_pntr;
		c_46_reg += a_4p_reg * *b_p6_pntr;
		c_47_reg += a_4p_reg * *b_p7_pntr;

		c_50_reg += a_5p_reg * *b_p0_pntr;
		c_51_reg += a_5p_reg * *b_p1_pntr;
		c_52_reg += a_5p_reg * *b_p2_pntr;
		c_53_reg += a_5p_reg * *b_p3_pntr;
		c_54_reg += a_5p_reg * *b_p4_pntr;
		c_55_reg += a_5p_reg * *b_p5_pntr;
		c_56_reg += a_5p_reg * *b_p6_pntr;
		c_57_reg += a_5p_reg * *b_p7_pntr;

		c_60_reg += a_6p_reg * *b_p0_pntr;
		c_61_reg += a_6p_reg * *b_p1_pntr;
		c_62_reg += a_6p_reg * *b_p2_pntr;
		c_63_reg += a_6p_reg * *b_p3_pntr;
		c_64_reg += a_6p_reg * *b_p4_pntr;
		c_65_reg += a_6p_reg * *b_p5_pntr;
		c_66_reg += a_6p_reg * *b_p6_pntr;
		c_67_reg += a_6p_reg * *b_p7_pntr;

		c_70_reg += a_7p_reg * *b_p0_pntr;
		c_71_reg += a_7p_reg * *b_p1_pntr;
		c_72_reg += a_7p_reg * *b_p2_pntr;
		c_73_reg += a_7p_reg * *b_p3_pntr;
		c_74_reg += a_7p_reg * *b_p4_pntr;
		c_75_reg += a_7p_reg * *b_p5_pntr;
		c_76_reg += a_7p_reg * *b_p6_pntr;
		c_77_reg += a_7p_reg * *b_p7_pntr;
	}
